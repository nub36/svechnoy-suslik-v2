...
export const SETTING_RU: Record<string, SettingText> = {
  /* ---------------- strategy selector + V3.0 ---------------- */
  'strategy.active': {
    label: 'Активная стратегия',
    description:
      'Какая стратегия работает сейчас. V3_0 — «HTF Liquidation Trap», прошедшая валидацию (net +0.0600 R/сделку на 536 сделках). V1_SMC — исходный движок Smart Money. V2.x в этой сборке не реализованы: их результаты получены отдельными исследовательскими скриптами.',
  },
  'v30.bodyRatioMin': {
    label: 'Мин. тело свечи возврата',
    description:
      'Минимальное отношение |close−open| / (high−low) свечи возврата. Валидированное значение 0.35. Повышение резко сокращает число сделок.',
  },
  'v30.rvolMin': {
    label: 'Мин. всплеск объёма (RVOL)',
    description:
      'Минимальный всплеск объёма на свече возврата, строго больше. Валидированное значение 1.25 — намеренно отличается от 1.2 в снайпере V2.x.',
  },
  'v30.corridorATR': {
    label: 'Полуширина коридора входа (ATR)',
    description:
      'Полуширина лимитного коридора вокруг закрытия свечи возврата, в ATR рабочего таймфрейма (risk.atr_period). Шире — больше исполнений по худшей средней цене.',
  },
  'v30.slBufferATR': {
    label: 'Буфер стопа за тенью (ATR)',
    description:
      'Расстояние от экстремума тени выноса до стопа, в ATR. Задаёт R для каждой сделки V3.0: меньше — выше доля комиссии в R.',
  },
  'v30.tp1Equilibrium': {
    label: 'Доля 4H ренджа до TP1',
    description:
      'Где внутри активного диапазона стоит первая цель: 0.50 = середина (равновесие 4H). Валидированное значение 0.50.',
  },
  'v30.breakevenTrigger': {
    label: 'Триггер безубытка',
    description:
      'Когда стоп по оставшейся части переносится в цену входа. Валидировано только «tp1»; «never» — непроверенный вариант, он убирает выходы «в ноль».',
  },
  'v30.timeoutBars': {
    label: 'Таймаут (свечей)',
    description:
      'Сколько свечей рабочего таймфрейма сделка может оставаться открытой, прежде чем закрыться по закрытию свечи. Свеча входа считается первой.',
  },
  'v30.positionSplitTP1': {
    label: 'Доля позиции на TP1',
    description:
      'Какая часть позиции закрывается на TP1; остаток идёт к TP2 или к безубытку. Валидированное значение 0.50.',
  },
  'v30.htfTimeframe': {
    label: 'Старший таймфрейм (уровни)',
    description:
      'Таймфрейм, подтверждённые свинги которого дают пробиваемый уровень, цель-равновесие и противоположную цель. Валидированное значение 4h.',
  },
  'v30.ltfTimeframe': {
    label: 'Рабочий таймфрейм (вход)',
    description:
      'Таймфрейм, на котором ищется вынос + возврат и выставляется коридор входа. Валидированное значение 1h.',
  },
  'v30.symbols': {
    label: 'Монеты стратегии',
    description:
      'Торгуемый набор валидированного кандидата: BTCUSDT, ETHUSDT, BNBUSDT, SOLUSDT, XRPUSDT, DOGEUSDT. Монета участвует только если воркер рынка её загружает.',
  },
  'v30.makerBps': {
    label: 'Комиссия мейкера (bps, вход)',
    description:
      'Комиссия входного плеча в базисных пунктах, на собственный нотионал плеча. Валидированный прогон: 2 bps на входе.',
  },
  'v30.takerBps': {
    label: 'Комиссия тейкера (bps, выходы)',
    description:
      'Комиссия выходных плеч в базисных пунктах. Каждый выход — рыночное событие, поэтому тейкер. Валидированный прогон: 5 bps, причём на ДВУХ выходных плечах, потому что половина позиции закрывается на TP1.',
  },
  /* ---------------- engine ---------------- */
  'engine.trading_mode': {
